...
class DaluTvsUpdate extends Command
{
     ...
     * @var string
     */
    protected $signature = 'caiji:ygdy8_dalutvs_update {page_start}{page_tot}{type_id}{aid?} {--queue=}';
     ...
     * @var string
     */
    protected $description = '跟踪采集阳光电影8的大陆电视剧信息';
    ...
    public function handle()
    {
        ...
        // max_page_tot = 16 typeid = 17
        $url = 'http://www.ygdy8.net/html/tv/hytv/list_71_2.html';
        //得到这条命令logs
        if ($this->isCommandLogs === true) {
            $command = "=========================================\n";
            $command .= date('Y-m-d H:i:s') . "\ncaiji:ygdy8_dalutvs_update {$pageStart} {$pageTot} {$this->typeId} {$queueName} \n the link is {$url} \n";
