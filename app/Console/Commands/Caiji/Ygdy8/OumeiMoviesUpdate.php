...
class OumeiMoviesUpdate extends Command
{
     ...
     * @var string
     */
    protected $signature = 'caiji:ygdy8_oumeimovies_update {page_start}{page_tot}{type_id}{--queue=}';
    ...
    public function handle()
    {
        ...
        if ($this->isCommandLogs === true) {
            $command = "=========================================\n";
            $command .= date('Y-m-d H:i:s') . "\ncaiji:ygdy8_oumeimovies_update {$pageStart} {$pageTot} {$this->typeId} {$queueName} \n the link is {$url} \n";
        ...
        //其余剩下的操作
        // php artisan caiji:ygdy8_get_content 15(type_id)
        $keyWordSuffix = '电影';
