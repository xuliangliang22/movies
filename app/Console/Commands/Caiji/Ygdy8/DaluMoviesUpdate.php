...
class DaluMoviesUpdate extends Command
{
     ...
     * @var string
     */
    protected $signature = 'caiji:ygdy8_dalumovies_update {page_start}{page_tot}{type_id}{aid?} {--queue=}';
    ...
    public function handle()
    {
        ...
        if ($this->isCommandLogs === true) {
            $command = "=========================================\n";
            $command .= date('Y-m-d H:i:s') . "\ncaiji:ygdy8_dalumovies_update {$pageStart} {$pageTot} {$this->typeId} {$aid} {$queueName} \n the link is {$url} \n";
