...
class GantaiTvs extends Command
{
    use Ygdy8;
    use Douban;
    use DedeLogin;
     ...
     * @var string
     */
    protected $signature = 'caiji:ygdy8_gantaitvs {aid?}';
     ...
     * @var string
     */
    protected $description = '采集阳光电影8的港台电视剧信息';
    ...
    public function handle()
    {
        ...
        //hepai 5
//        $url = 'http://www.ygdy8.net/html/tv/hepai/list_10_2.html';
        $url = 'http://www.ygdy8.net/html/tv/gangtai/index.html';
        $pageStart = 1;
        $pageTot = 1;
        //得到所有的列表页
        $this->MovieInit();
